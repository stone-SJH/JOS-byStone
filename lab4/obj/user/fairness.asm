...
umain(int argc, char **argv)
{
  ...
  800039:	83 ec 20             	sub    $0x20,%esp
	...
	id = sys_getenvid();
  80003c:	e8 25 10 00 00       	call   801066 <sys_getenvid>
  ...
  800075:	c7 04 24 a0 14 80 00 	movl   $0x8014a0,(%esp)
  ...
  800090:	c7 04 24 b1 14 80 00 	movl   $0x8014b1,(%esp)
  ...
  8000be:	e8 9a 10 00 00       	call   80115d <ipc_send>
...
libmain(int argc, char **argv)
{
  ...
  8000da:	e8 87 0f 00 00       	call   801066 <sys_getenvid>
...
exit(void)
{
  ...
  800125:	e8 7c 0f 00 00       	call   8010a6 <sys_env_destroy>
}
  80012a:	c9                   	leave  
  80012b:	c3                   	ret    
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800180:	e8 17 0b 00 00       	call   800c9c <sys_cputs>
...
putch(int ch, struct printbuf *b)
{
  ...
  8001d4:	e8 c3 0a 00 00       	call   800c9c <sys_cputs>
		b->idx = 0;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80026d:	e8 ae 0f 00 00       	call   801220 <__udivdi3>
  ...
  8002c8:	e8 83 10 00 00       	call   801350 <__umoddi3>
  8002cd:	89 74 24 04          	mov    %esi,0x4(%esp)
  8002d1:	0f be 80 d2 14 80 00 	movsbl 0x8014d2(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80048f:	c7 44 24 08 e3 14 80 	movl   $0x8014e3,0x8(%esp)
  800496:	00 
  ...
  8004af:	c7 44 24 08 ec 14 80 	movl   $0x8014ec,0x8(%esp)
  8004b6:	00 
  ...
  8004eb:	c7 45 c4 ef 14 80 00 	movl   $0x8014ef,-0x3c(%ebp)
				p = "(null)";
			if (width > 0 && padc != '-')
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800d78:	e8 27 04 00 00       	call   8011a4 <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800e25:	e8 7a 03 00 00       	call   8011a4 <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800e91:	e8 0e 03 00 00       	call   8011a4 <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800efd:	e8 a2 02 00 00       	call   8011a4 <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800f68:	e8 37 02 00 00       	call   8011a4 <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800fd5:	e8 ca 01 00 00       	call   8011a4 <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  801102:	e8 9d 00 00 00       	call   8011a4 <_panic>
...
ipc_find_env(enum EnvType type)
{
  ...
  80111a:	8b 15 50 00 c0 ee    	mov    0xeec00050,%edx
  801120:	b8 01 00 00 00       	mov    $0x1,%eax
  801125:	39 ca                	cmp    %ecx,%edx
  801127:	75 04                	jne    80112d <ipc_find_env+0x19>
  801129:	b0 00                	mov    $0x0,%al
  80112b:	eb 11                	jmp    80113e <ipc_find_env+0x2a>
  80112d:	89 c2                	mov    %eax,%edx
  80112f:	c1 e2 07             	shl    $0x7,%edx
  801132:	81 c2 50 00 c0 ee    	add    $0xeec00050,%edx
  801138:	8b 12                	mov    (%edx),%edx
  80113a:	39 ca                	cmp    %ecx,%edx
  80113c:	75 0f                	jne    80114d <ipc_find_env+0x39>
			return envs[i].env_id;
  80113e:	8d 44 00 01          	lea    0x1(%eax,%eax,1),%eax
  801142:	c1 e0 06             	shl    $0x6,%eax
  801145:	8b 80 08 00 c0 ee    	mov    -0x113ffff8(%eax),%eax
  80114b:	eb 0e                	jmp    80115b <ipc_find_env+0x47>
// Returns 0 if no such environment exists.
envid_t
ipc_find_env(enum EnvType type)
{
  ...
  801150:	3d 00 04 00 00       	cmp    $0x400,%eax
  801155:	75 d6                	jne    80112d <ipc_find_env+0x19>
  801157:	66 b8 00 00          	mov    $0x0,%ax
		if (envs[i].env_type == type)
			return envs[i].env_id;
	return 0;
}
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801163:	c7 44 24 08 4f 17 80 	movl   $0x80174f,0x8(%esp)
  80116a:	00 
  80116b:	c7 44 24 04 2a 00 00 	movl   $0x2a,0x4(%esp)
  801172:	00 
  801173:	c7 04 24 68 17 80 00 	movl   $0x801768,(%esp)
  80117a:	e8 25 00 00 00       	call   8011a4 <_panic>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  801185:	c7 44 24 08 72 17 80 	movl   $0x801772,0x8(%esp)
  80118c:	00 
  80118d:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%esp)
  801194:	00 
  801195:	c7 04 24 68 17 80 00 	movl   $0x801768,(%esp)
  80119c:	e8 03 00 00 00       	call   8011a4 <_panic>
...
_panic(const char *file, int line, const char *fmt, ...)
  8011ac:	8d 75 14             	lea    0x14(%ebp),%esi
	...
	if (argv0)
  8011af:	a1 08 20 80 00       	mov    0x802008,%eax
  8011b4:	85 c0                	test   %eax,%eax
  8011b6:	74 10                	je     8011c8 <_panic+0x24>
		cprintf("%s: ", argv0);
  8011b8:	89 44 24 04          	mov    %eax,0x4(%esp)
  8011bc:	c7 04 24 8b 17 80 00 	movl   $0x80178b,(%esp)
  8011c3:	e8 c5 ef ff ff       	call   80018d <cprintf>
	cprintf("[%08x] user panic in %s at %s:%d: ",
  8011c8:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  8011ce:	e8 93 fe ff ff       	call   801066 <sys_getenvid>
  8011d3:	8b 55 0c             	mov    0xc(%ebp),%edx
  8011d6:	89 54 24 10          	mov    %edx,0x10(%esp)
  8011da:	8b 55 08             	mov    0x8(%ebp),%edx
  8011dd:	89 54 24 0c          	mov    %edx,0xc(%esp)
  8011e1:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  8011e5:	89 44 24 04          	mov    %eax,0x4(%esp)
  8011e9:	c7 04 24 90 17 80 00 	movl   $0x801790,(%esp)
  8011f0:	e8 98 ef ff ff       	call   80018d <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8011f5:	89 74 24 04          	mov    %esi,0x4(%esp)
  8011f9:	8b 45 10             	mov    0x10(%ebp),%eax
  8011fc:	89 04 24             	mov    %eax,(%esp)
  8011ff:	e8 28 ef ff ff       	call   80012c <vcprintf>
	cprintf("\n");
  801204:	c7 04 24 af 14 80 00 	movl   $0x8014af,(%esp)
  80120b:	e8 7d ef ff ff       	call   80018d <cprintf>
	...
	while (1)
		asm volatile("int3");
  801210:	cc                   	int3   
  801211:	eb fd                	jmp    801210 <_panic+0x6c>
	...
...
00801220 <__udivdi3>:
  ...
  801270:	39 f8                	cmp    %edi,%eax
  801272:	77 1c                	ja     801290 <__udivdi3+0x70>
  801274:	0f bd d0             	bsr    %eax,%edx
  801277:	83 f2 1f             	xor    $0x1f,%edx
  80127a:	89 55 f4             	mov    %edx,-0xc(%ebp)
  80127d:	75 39                	jne    8012b8 <__udivdi3+0x98>
  80127f:	3b 75 f0             	cmp    -0x10(%ebp),%esi
  801282:	0f 86 a0 00 00 00    	jbe    801328 <__udivdi3+0x108>
  801288:	39 f8                	cmp    %edi,%eax
  80128a:	0f 82 98 00 00 00    	jb     801328 <__udivdi3+0x108>
  801290:	31 ff                	xor    %edi,%edi
  801292:	31 c9                	xor    %ecx,%ecx
  ...
  8012a6:	31 ff                	xor    %edi,%edi
  8012a8:	f7 f6                	div    %esi
  8012aa:	89 c1                	mov    %eax,%ecx
  8012ac:	89 fa                	mov    %edi,%edx
  ...
  8012b6:	c3                   	ret    
  8012b7:	90                   	nop
  8012b8:	0f b6 4d f4          	movzbl -0xc(%ebp),%ecx
  8012bc:	89 f2                	mov    %esi,%edx
  8012be:	d3 e0                	shl    %cl,%eax
  8012c0:	89 45 ec             	mov    %eax,-0x14(%ebp)
  8012c3:	b8 20 00 00 00       	mov    $0x20,%eax
  8012c8:	2b 45 f4             	sub    -0xc(%ebp),%eax
  8012cb:	89 c1                	mov    %eax,%ecx
  8012cd:	d3 ea                	shr    %cl,%edx
  8012cf:	0f b6 4d f4          	movzbl -0xc(%ebp),%ecx
  8012d3:	0b 55 ec             	or     -0x14(%ebp),%edx
  8012d6:	d3 e6                	shl    %cl,%esi
  8012d8:	89 c1                	mov    %eax,%ecx
  8012da:	89 75 e8             	mov    %esi,-0x18(%ebp)
  8012dd:	89 fe                	mov    %edi,%esi
  8012df:	d3 ee                	shr    %cl,%esi
  8012e1:	0f b6 4d f4          	movzbl -0xc(%ebp),%ecx
  ...
  8012f1:	09 d7                	or     %edx,%edi
  8012f3:	89 f2                	mov    %esi,%edx
  8012f5:	89 f8                	mov    %edi,%eax
  8012f7:	f7 75 ec             	divl   -0x14(%ebp)
  8012fa:	89 d6                	mov    %edx,%esi
  8012fc:	89 c7                	mov    %eax,%edi
  8012fe:	f7 65 e8             	mull   -0x18(%ebp)
  801301:	39 d6                	cmp    %edx,%esi
  801303:	89 55 ec             	mov    %edx,-0x14(%ebp)
  801306:	72 30                	jb     801338 <__udivdi3+0x118>
  801308:	8b 55 f0             	mov    -0x10(%ebp),%edx
  80130b:	0f b6 4d f4          	movzbl -0xc(%ebp),%ecx
  80130f:	d3 e2                	shl    %cl,%edx
  801311:	39 c2                	cmp    %eax,%edx
  801313:	73 05                	jae    80131a <__udivdi3+0xfa>
  801315:	3b 75 ec             	cmp    -0x14(%ebp),%esi
  801318:	74 1e                	je     801338 <__udivdi3+0x118>
  80131a:	89 f9                	mov    %edi,%ecx
  80131c:	31 ff                	xor    %edi,%edi
  80131e:	e9 71 ff ff ff       	jmp    801294 <__udivdi3+0x74>
  801323:	90                   	nop
  801324:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  801328:	31 ff                	xor    %edi,%edi
  80132a:	b9 01 00 00 00       	mov    $0x1,%ecx
  80132f:	e9 60 ff ff ff       	jmp    801294 <__udivdi3+0x74>
  801334:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  801338:	8d 4f ff             	lea    -0x1(%edi),%ecx
...
00801350 <__umoddi3>:
  ...
  80135e:	8b 7d 10             	mov    0x10(%ebp),%edi
  801361:	8b 75 0c             	mov    0xc(%ebp),%esi
  801364:	85 d2                	test   %edx,%edx
  801366:	89 c8                	mov    %ecx,%eax
  801368:	89 4d f4             	mov    %ecx,-0xc(%ebp)
  80136b:	75 13                	jne    801380 <__umoddi3+0x30>
  80136d:	39 f7                	cmp    %esi,%edi
  80136f:	76 3f                	jbe    8013b0 <__umoddi3+0x60>
  801371:	89 f2                	mov    %esi,%edx
  801373:	f7 f7                	div    %edi
  801375:	89 d0                	mov    %edx,%eax
  801377:	31 d2                	xor    %edx,%edx
  801379:	83 c4 20             	add    $0x20,%esp
  80137c:	5e                   	pop    %esi
  80137d:	5f                   	pop    %edi
  80137e:	5d                   	pop    %ebp
  80137f:	c3                   	ret    
  801380:	39 f2                	cmp    %esi,%edx
  801382:	77 4c                	ja     8013d0 <__umoddi3+0x80>
  801384:	0f bd ca             	bsr    %edx,%ecx
  801387:	83 f1 1f             	xor    $0x1f,%ecx
  80138a:	89 4d f0             	mov    %ecx,-0x10(%ebp)
  80138d:	75 51                	jne    8013e0 <__umoddi3+0x90>
  80138f:	3b 7d f4             	cmp    -0xc(%ebp),%edi
  801392:	0f 87 e0 00 00 00    	ja     801478 <__umoddi3+0x128>
  801398:	8b 45 f4             	mov    -0xc(%ebp),%eax
  80139b:	29 f8                	sub    %edi,%eax
  80139d:	19 d6                	sbb    %edx,%esi
  ...
  8013e0:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  8013e4:	d3 e2                	shl    %cl,%edx
  8013e6:	89 55 f4             	mov    %edx,-0xc(%ebp)
  8013e9:	ba 20 00 00 00       	mov    $0x20,%edx
  8013ee:	2b 55 f0             	sub    -0x10(%ebp),%edx
  8013f1:	89 55 ec             	mov    %edx,-0x14(%ebp)
  8013f4:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  8013f8:	89 fa                	mov    %edi,%edx
  8013fa:	d3 ea                	shr    %cl,%edx
  8013fc:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  801400:	0b 55 f4             	or     -0xc(%ebp),%edx
  801403:	d3 e7                	shl    %cl,%edi
  801405:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  801409:	89 55 f4             	mov    %edx,-0xc(%ebp)
  80140c:	89 f2                	mov    %esi,%edx
  80140e:	89 7d e8             	mov    %edi,-0x18(%ebp)
  801411:	89 c7                	mov    %eax,%edi
  801413:	d3 ea                	shr    %cl,%edx
  801415:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  801419:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  80141c:	89 c2                	mov    %eax,%edx
  80141e:	d3 e6                	shl    %cl,%esi
  801420:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  801424:	d3 ea                	shr    %cl,%edx
  801426:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  80142a:	09 d6                	or     %edx,%esi
  80142c:	89 f0                	mov    %esi,%eax
  80142e:	8b 75 e4             	mov    -0x1c(%ebp),%esi
  801431:	d3 e7                	shl    %cl,%edi
  801433:	89 f2                	mov    %esi,%edx
  801435:	f7 75 f4             	divl   -0xc(%ebp)
  801438:	89 d6                	mov    %edx,%esi
  80143a:	f7 65 e8             	mull   -0x18(%ebp)
  80143d:	39 d6                	cmp    %edx,%esi
  80143f:	72 2b                	jb     80146c <__umoddi3+0x11c>
  801441:	39 c7                	cmp    %eax,%edi
  801443:	72 23                	jb     801468 <__umoddi3+0x118>
  801445:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  801449:	29 c7                	sub    %eax,%edi
  80144b:	19 d6                	sbb    %edx,%esi
  80144d:	89 f0                	mov    %esi,%eax
  80144f:	89 f2                	mov    %esi,%edx
  801451:	d3 ef                	shr    %cl,%edi
  801453:	0f b6 4d ec          	movzbl -0x14(%ebp),%ecx
  801457:	d3 e0                	shl    %cl,%eax
  801459:	0f b6 4d f0          	movzbl -0x10(%ebp),%ecx
  80145d:	09 f8                	or     %edi,%eax
  ...
  801466:	5d                   	pop    %ebp
  801467:	c3                   	ret    
  801468:	39 d6                	cmp    %edx,%esi
  80146a:	75 d9                	jne    801445 <__umoddi3+0xf5>
  80146c:	2b 45 e8             	sub    -0x18(%ebp),%eax
  80146f:	1b 55 f4             	sbb    -0xc(%ebp),%edx
  801472:	eb d1                	jmp    801445 <__umoddi3+0xf5>
  801474:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  801478:	39 f2                	cmp    %esi,%edx
  80147a:	0f 82 18 ff ff ff    	jb     801398 <__umoddi3+0x48>
  801480:	e9 1d ff ff ff       	jmp    8013a2 <__umoddi3+0x52>
