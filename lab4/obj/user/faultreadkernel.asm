	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800261:	0f be 80 d1 13 80 00 	movsbl 0x8013d1(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800345:	ff 24 95 a0 14 80 00 	jmp    *0x8014a0(,%edx,4)
  ...
  80043f:	c7 44 24 08 eb 13 80 	movl   $0x8013eb,0x8(%esp)
  800446:	00 
  ...
  80047b:	c7 45 c4 ee 13 80 00 	movl   $0x8013ee,-0x3c(%ebp)
				p = "(null)";
			if (width > 0 && padc != '-')
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800cf0:	00 
  800cf1:	c7 44 24 08 24 16 80 	movl   $0x801624,0x8(%esp)
  800cf8:	00 
  800cf9:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  800d00:	00 
  800d01:	c7 04 24 41 16 80 00 	movl   $0x801641,(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800e09:	00 
  800e0a:	c7 44 24 08 24 16 80 	movl   $0x801624,0x8(%esp)
  800e11:	00 
  800e12:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  800e19:	00 
  800e1a:	c7 04 24 41 16 80 00 	movl   $0x801641,(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800e75:	00 
  800e76:	c7 44 24 08 24 16 80 	movl   $0x801624,0x8(%esp)
  800e7d:	00 
  800e7e:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  800e85:	00 
  800e86:	c7 04 24 41 16 80 00 	movl   $0x801641,(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800ee0:	00 
  800ee1:	c7 44 24 08 24 16 80 	movl   $0x801624,0x8(%esp)
  800ee8:	00 
  800ee9:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  800ef0:	00 
  800ef1:	c7 04 24 41 16 80 00 	movl   $0x801641,(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800f4d:	00 
  800f4e:	c7 44 24 08 24 16 80 	movl   $0x801624,0x8(%esp)
  800f55:	00 
  800f56:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  800f5d:	00 
  800f5e:	c7 04 24 41 16 80 00 	movl   $0x801641,(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80107a:	00 
  80107b:	c7 44 24 08 24 16 80 	movl   $0x801624,0x8(%esp)
  801082:	00 
  801083:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  80108a:	00 
  80108b:	c7 04 24 41 16 80 00 	movl   $0x801641,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  8010bc:	c7 04 24 4f 16 80 00 	movl   $0x80164f,(%esp)
  ...
  8010e9:	c7 04 24 58 16 80 00 	movl   $0x801658,(%esp)
  ...
  8010ff:	e8 b4 ef ff ff       	call   8000b8 <vcprintf>
	cprintf("\n");
  801104:	c7 04 24 54 16 80 00 	movl   $0x801654,(%esp)
