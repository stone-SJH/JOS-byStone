...
libmain(int argc, char **argv)
{
  ...
  80004e:	e8 57 04 00 00       	call   8004aa <sys_getenvid>
...
exit(void)
{
  ...
  800099:	e8 4c 04 00 00       	call   8004ea <sys_env_destroy>
}
  80009e:	c9                   	leave  
  80009f:	c3                   	ret    
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8000c6:	8d 35 ce 00 80 00    	lea    0x8000ce,%esi
...
sys_cgetc(void)
{
  ...
  8000d8:	8b 7c 24 04          	mov    0x4(%esp),%edi
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800105:	8d 35 0d 01 80 00    	lea    0x80010d,%esi
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800131:	b8 0e 00 00 00       	mov    $0xe,%eax
  ...
  800146:	8d 35 4e 01 80 00    	lea    0x80014e,%esi
  80014c:	0f 34                	sysenter 
  80014e:	5f                   	pop    %edi
  80014f:	5e                   	pop    %esi
  800150:	5d                   	pop    %ebp
  800151:	5c                   	pop    %esp
...
sys_sbrk(uint32_t inc)
{
  ...
  800155:	8b 1c 24             	mov    (%esp),%ebx
  800158:	8b 7c 24 04          	mov    0x4(%esp),%edi
  80015c:	89 ec                	mov    %ebp,%esp
  80015e:	5d                   	pop    %ebp
  80015f:	c3                   	ret    

00800160 <sys_ipc_recv>:
...
sys_ipc_recv(void *dstva)
{
  ...
  800166:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  800169:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800179:	89 cb                	mov    %ecx,%ebx
  80017b:	89 cf                	mov    %ecx,%edi
  80017d:	51                   	push   %ecx
  80017e:	52                   	push   %edx
  80017f:	53                   	push   %ebx
  800180:	54                   	push   %esp
  ...
  800197:	7e 28                	jle    8001c1 <sys_ipc_recv+0x61>
		panic("syscall %d returned %d (> 0)", num, ret);
  800199:	89 44 24 10          	mov    %eax,0x10(%esp)
  80019d:	c7 44 24 0c 0d 00 00 	movl   $0xd,0xc(%esp)
  8001a4:	00 
  8001a5:	c7 44 24 08 8a 13 80 	movl   $0x80138a,0x8(%esp)
  8001ac:	00 
  8001ad:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  8001b4:	00 
  8001b5:	c7 04 24 a7 13 80 00 	movl   $0x8013a7,(%esp)
  8001bc:	e8 97 03 00 00       	call   800558 <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  8001d8:	b8 0c 00 00 00       	mov    $0xc,%eax
...
0080020c <sys_env_set_pgfault_upcall>:
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80021d:	b8 0a 00 00 00       	mov    $0xa,%eax
  ...
  800233:	8d 35 3b 02 80 00    	lea    0x80023b,%esi
  800239:	0f 34                	sysenter 
  80023b:	5f                   	pop    %edi
  80023c:	5e                   	pop    %esi
  80023d:	5d                   	pop    %ebp
  80023e:	5c                   	pop    %esp
  ...
  800244:	7e 28                	jle    80026e <sys_env_set_pgfault_upcall+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  800246:	89 44 24 10          	mov    %eax,0x10(%esp)
  80024a:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  800251:	00 
  800252:	c7 44 24 08 8a 13 80 	movl   $0x80138a,0x8(%esp)
  800259:	00 
  80025a:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  800261:	00 
  800262:	c7 04 24 a7 13 80 00 	movl   $0x8013a7,(%esp)
  800269:	e8 ea 02 00 00       	call   800558 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80026e:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  800271:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80027e:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  800281:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80029f:	8d 35 a7 02 80 00    	lea    0x8002a7,%esi
  8002a5:	0f 34                	sysenter 
  8002a7:	5f                   	pop    %edi
  8002a8:	5e                   	pop    %esi
  8002a9:	5d                   	pop    %ebp
  8002aa:	5c                   	pop    %esp
  ...
  8002b0:	7e 28                	jle    8002da <sys_env_set_status+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  8002b2:	89 44 24 10          	mov    %eax,0x10(%esp)
  8002b6:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  8002bd:	00 
  8002be:	c7 44 24 08 8a 13 80 	movl   $0x80138a,0x8(%esp)
  8002c5:	00 
  8002c6:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  8002cd:	00 
  8002ce:	c7 04 24 a7 13 80 00 	movl   $0x8013a7,(%esp)
  8002d5:	e8 7e 02 00 00       	call   800558 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  8002da:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  8002dd:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8002e0:	89 ec                	mov    %ebp,%esp
  8002e2:	5d                   	pop    %ebp
  8002e3:	c3                   	ret    
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002ea:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  8002ed:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8002f5:	b8 07 00 00 00       	mov    $0x7,%eax
  ...
  80031c:	7e 28                	jle    800346 <sys_page_unmap+0x62>
		panic("syscall %d returned %d (> 0)", num, ret);
  80031e:	89 44 24 10          	mov    %eax,0x10(%esp)
  800322:	c7 44 24 0c 07 00 00 	movl   $0x7,0xc(%esp)
  800329:	00 
  80032a:	c7 44 24 08 8a 13 80 	movl   $0x80138a,0x8(%esp)
  800331:	00 
  800332:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  800339:	00 
  80033a:	c7 04 24 a7 13 80 00 	movl   $0x8013a7,(%esp)
  800341:	e8 12 02 00 00       	call   800558 <_panic>
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
	int32_t ret;
	asm volatile("pushl %%ecx\n\t"
  80035c:	b8 06 00 00 00       	mov    $0x6,%eax
  800361:	8b 7d 14             	mov    0x14(%ebp),%edi
  800364:	8b 5d 10             	mov    0x10(%ebp),%ebx
  ...
  800387:	7e 28                	jle    8003b1 <sys_page_map+0x61>
		panic("syscall %d returned %d (> 0)", num, ret);
  800389:	89 44 24 10          	mov    %eax,0x10(%esp)
  80038d:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  800394:	00 
  800395:	c7 44 24 08 8a 13 80 	movl   $0x80138a,0x8(%esp)
  80039c:	00 
  80039d:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  8003a4:	00 
  8003a5:	c7 04 24 a7 13 80 00 	movl   $0x8013a7,(%esp)
  8003ac:	e8 a7 01 00 00       	call   800558 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8003c1:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  8003c4:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8003cc:	b8 05 00 00 00       	mov    $0x5,%eax
  8003d1:	8b 5d 10             	mov    0x10(%ebp),%ebx
  ...
  8003e3:	8d 35 eb 03 80 00    	lea    0x8003eb,%esi
  8003e9:	0f 34                	sysenter 
  8003eb:	5f                   	pop    %edi
  8003ec:	5e                   	pop    %esi
  8003ed:	5d                   	pop    %ebp
  8003ee:	5c                   	pop    %esp
  ...
  8003f4:	7e 28                	jle    80041e <sys_page_alloc+0x63>
		panic("syscall %d returned %d (> 0)", num, ret);
  8003f6:	89 44 24 10          	mov    %eax,0x10(%esp)
  8003fa:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  800401:	00 
  800402:	c7 44 24 08 8a 13 80 	movl   $0x80138a,0x8(%esp)
  800409:	00 
  80040a:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  800411:	00 
  800412:	c7 04 24 a7 13 80 00 	movl   $0x8013a7,(%esp)
  800419:	e8 3a 01 00 00       	call   800558 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80041e:	8b 5d f8             	mov    -0x8(%ebp),%ebx
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80044e:	8d 35 56 04 80 00    	lea    0x800456,%esi
  800454:	0f 34                	sysenter 
  800456:	5f                   	pop    %edi
  800457:	5e                   	pop    %esi
  800458:	5d                   	pop    %ebp
  800459:	5c                   	pop    %esp
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800490:	8d 35 98 04 80 00    	lea    0x800498,%esi
  800496:	0f 34                	sysenter 
  800498:	5f                   	pop    %edi
  800499:	5e                   	pop    %esi
  80049a:	5d                   	pop    %ebp
  80049b:	5c                   	pop    %esp
...
sys_map_kernel_page(void* kpage, void* va)
{
  ...
  80049f:	8b 1c 24             	mov    (%esp),%ebx
  8004a2:	8b 7c 24 04          	mov    0x4(%esp),%edi
  8004a6:	89 ec                	mov    %ebp,%esp
  8004a8:	5d                   	pop    %ebp
  8004a9:	c3                   	ret    

008004aa <sys_getenvid>:
...
sys_getenvid(void)
{
  ...
  8004b3:	89 7c 24 04          	mov    %edi,0x4(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8004bc:	b8 02 00 00 00       	mov    $0x2,%eax
  ...
  8004d0:	8d 35 d8 04 80 00    	lea    0x8004d8,%esi
  8004d6:	0f 34                	sysenter 
  8004d8:	5f                   	pop    %edi
  8004d9:	5e                   	pop    %esi
  8004da:	5d                   	pop    %ebp
  8004db:	5c                   	pop    %esp
...
sys_getenvid(void)
{
  ...
  8004df:	8b 1c 24             	mov    (%esp),%ebx
  8004e2:	8b 7c 24 04          	mov    0x4(%esp),%edi
  8004e6:	89 ec                	mov    %ebp,%esp
  8004e8:	5d                   	pop    %ebp
  8004e9:	c3                   	ret    

008004ea <sys_env_destroy>:
	return syscall(SYS_cgetc, 0, 0, 0, 0, 0, 0);
}
...
sys_env_destroy(envid_t envid)
{
  ...
  8004f0:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  8004f3:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  8004fb:	b8 03 00 00 00       	mov    $0x3,%eax
  ...
  800510:	8d 35 18 05 80 00    	lea    0x800518,%esi
  800516:	0f 34                	sysenter 
  800518:	5f                   	pop    %edi
  800519:	5e                   	pop    %esi
  80051a:	5d                   	pop    %ebp
  80051b:	5c                   	pop    %esp
  ...
  800521:	7e 28                	jle    80054b <sys_env_destroy+0x61>
		panic("syscall %d returned %d (> 0)", num, ret);
  800523:	89 44 24 10          	mov    %eax,0x10(%esp)
  800527:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  80052e:	00 
  80052f:	c7 44 24 08 8a 13 80 	movl   $0x80138a,0x8(%esp)
  800536:	00 
  800537:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  80053e:	00 
  80053f:	c7 04 24 a7 13 80 00 	movl   $0x8013a7,(%esp)
  800546:	e8 0d 00 00 00       	call   800558 <_panic>
...
sys_env_destroy(envid_t envid)
{
  ...
  80054b:	8b 5d f8             	mov    -0x8(%ebp),%ebx
  80054e:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800551:	89 ec                	mov    %ebp,%esp
  800553:	5d                   	pop    %ebp
  800554:	c3                   	ret    
  800555:	00 00                	add    %al,(%eax)
	...
...
void
_panic(const char *file, int line, const char *fmt, ...)
  800560:	8d 75 14             	lea    0x14(%ebp),%esi
	va_list ap;
	...
	if (argv0)
  800563:	a1 08 20 80 00       	mov    0x802008,%eax
  800568:	85 c0                	test   %eax,%eax
  80056a:	74 10                	je     80057c <_panic+0x24>
		cprintf("%s: ", argv0);
  80056c:	89 44 24 04          	mov    %eax,0x4(%esp)
  800570:	c7 04 24 b5 13 80 00 	movl   $0x8013b5,(%esp)
  800577:	e8 ad 00 00 00       	call   800629 <cprintf>
	cprintf("[%08x] user panic in %s at %s:%d: ",
  80057c:	8b 1d 00 20 80 00    	mov    0x802000,%ebx
  800582:	e8 23 ff ff ff       	call   8004aa <sys_getenvid>
  800587:	8b 55 0c             	mov    0xc(%ebp),%edx
  80058a:	89 54 24 10          	mov    %edx,0x10(%esp)
  80058e:	8b 55 08             	mov    0x8(%ebp),%edx
  800591:	89 54 24 0c          	mov    %edx,0xc(%esp)
  800595:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  800599:	89 44 24 04          	mov    %eax,0x4(%esp)
  80059d:	c7 04 24 bc 13 80 00 	movl   $0x8013bc,(%esp)
  8005a4:	e8 80 00 00 00       	call   800629 <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  8005a9:	89 74 24 04          	mov    %esi,0x4(%esp)
  8005ad:	8b 45 10             	mov    0x10(%ebp),%eax
  8005b0:	89 04 24             	mov    %eax,(%esp)
  8005b3:	e8 10 00 00 00       	call   8005c8 <vcprintf>
	cprintf("\n");
  8005b8:	c7 04 24 ba 13 80 00 	movl   $0x8013ba,(%esp)
  8005bf:	e8 65 00 00 00       	call   800629 <cprintf>

	// Cause a breakpoint exception
	while (1)
		asm volatile("int3");
  8005c4:	cc                   	int3   
  8005c5:	eb fd                	jmp    8005c4 <_panic+0x6c>
	...
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  8005cb:	81 ec 28 01 00 00    	sub    $0x128,%esp
	struct printbuf b;
  ...
  8005e8:	89 44 24 0c          	mov    %eax,0xc(%esp)
  ...
  8005fd:	c7 04 24 43 06 80 00 	movl   $0x800643,(%esp)
  800604:	e8 d4 01 00 00       	call   8007dd <vprintfmt>
	sys_cputs(b.buf, b.idx);
  800609:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
  80060f:	89 44 24 04          	mov    %eax,0x4(%esp)
  800613:	8d 85 f8 fe ff ff    	lea    -0x108(%ebp),%eax
  800619:	89 04 24             	mov    %eax,(%esp)
  80061c:	e8 bf fa ff ff       	call   8000e0 <sys_cputs>

	return b.cnt;
}
  800621:	8b 85 f4 fe ff ff    	mov    -0x10c(%ebp),%eax
  800627:	c9                   	leave  
  800628:	c3                   	ret    
  ...
  80062f:	8d 45 0c             	lea    0xc(%ebp),%eax
{
  ...
  80063c:	e8 87 ff ff ff       	call   8005c8 <vcprintf>
	va_end(ap);
...
putch(int ch, struct printbuf *b)
{
  ...
  80064a:	8b 5d 0c             	mov    0xc(%ebp),%ebx
	b->buf[b->idx++] = ch;
  80064d:	8b 03                	mov    (%ebx),%eax
  80064f:	8b 55 08             	mov    0x8(%ebp),%edx
  800652:	88 54 03 08          	mov    %dl,0x8(%ebx,%eax,1)
  800656:	83 c0 01             	add    $0x1,%eax
  800659:	89 03                	mov    %eax,(%ebx)
	if (b->idx == 256-1) {
  80065b:	3d ff 00 00 00       	cmp    $0xff,%eax
  800660:	75 19                	jne    80067b <putch+0x38>
		sys_cputs(b->buf, b->idx);
  800662:	c7 44 24 04 ff 00 00 	movl   $0xff,0x4(%esp)
  800669:	00 
  80066a:	8d 43 08             	lea    0x8(%ebx),%eax
  80066d:	89 04 24             	mov    %eax,(%esp)
  800670:	e8 6b fa ff ff       	call   8000e0 <sys_cputs>
		b->idx = 0;
  800675:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
	}
	b->cnt++;
  80067b:	83 43 04 01          	addl   $0x1,0x4(%ebx)
}
  80067f:	83 c4 14             	add    $0x14,%esp
  800682:	5b                   	pop    %ebx
  800683:	5d                   	pop    %ebp
  800684:	c3                   	ret    
	...
