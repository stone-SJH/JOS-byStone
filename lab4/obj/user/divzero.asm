...
libmain(int argc, char **argv)
{
  ...
  80007a:	e8 87 0f 00 00       	call   801006 <sys_getenvid>
...
exit(void)
{
  ...
  8000c5:	e8 7c 0f 00 00       	call   801046 <sys_env_destroy>
}
  8000ca:	c9                   	leave  
  8000cb:	c3                   	ret    
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800120:	e8 17 0b 00 00       	call   800c3c <sys_cputs>
...
putch(int ch, struct printbuf *b)
{
  ...
  800174:	e8 c3 0a 00 00       	call   800c3c <sys_cputs>
		b->idx = 0;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800271:	0f be 80 b8 13 80 00 	movsbl 0x8013b8(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800355:	ff 24 95 80 14 80 00 	jmp    *0x801480(,%edx,4)
  ...
  80044f:	c7 44 24 08 d2 13 80 	movl   $0x8013d2,0x8(%esp)
  800456:	00 
  ...
  80048b:	c7 45 c4 d5 13 80 00 	movl   $0x8013d5,-0x3c(%ebp)
				p = "(null)";
			if (width > 0 && padc != '-')
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800d00:	00 
  800d01:	c7 44 24 08 04 16 80 	movl   $0x801604,0x8(%esp)
  800d08:	00 
  800d09:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  800d10:	00 
  800d11:	c7 04 24 21 16 80 00 	movl   $0x801621,(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800dad:	00 
  800dae:	c7 44 24 08 04 16 80 	movl   $0x801604,0x8(%esp)
  800db5:	00 
  800db6:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  800dbd:	00 
  800dbe:	c7 04 24 21 16 80 00 	movl   $0x801621,(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800e19:	00 
  800e1a:	c7 44 24 08 04 16 80 	movl   $0x801604,0x8(%esp)
  800e21:	00 
  800e22:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  800e29:	00 
  800e2a:	c7 04 24 21 16 80 00 	movl   $0x801621,(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800e85:	00 
  800e86:	c7 44 24 08 04 16 80 	movl   $0x801604,0x8(%esp)
  800e8d:	00 
  800e8e:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  800e95:	00 
  800e96:	c7 04 24 21 16 80 00 	movl   $0x801621,(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800ef0:	00 
  800ef1:	c7 44 24 08 04 16 80 	movl   $0x801604,0x8(%esp)
  800ef8:	00 
  800ef9:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  800f00:	00 
  800f01:	c7 04 24 21 16 80 00 	movl   $0x801621,(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800f5d:	00 
  800f5e:	c7 44 24 08 04 16 80 	movl   $0x801604,0x8(%esp)
  800f65:	00 
  800f66:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  800f6d:	00 
  800f6e:	c7 04 24 21 16 80 00 	movl   $0x801621,(%esp)
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  80108a:	00 
  80108b:	c7 44 24 08 04 16 80 	movl   $0x801604,0x8(%esp)
  801092:	00 
  801093:	c7 44 24 04 2c 00 00 	movl   $0x2c,0x4(%esp)
  80109a:	00 
  80109b:	c7 04 24 21 16 80 00 	movl   $0x801621,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
  ...
  8010cc:	c7 04 24 2f 16 80 00 	movl   $0x80162f,(%esp)
  8010d3:	e8 55 f0 ff ff       	call   80012d <cprintf>
  ...
  8010f9:	c7 04 24 34 16 80 00 	movl   $0x801634,(%esp)
  801100:	e8 28 f0 ff ff       	call   80012d <cprintf>
		sys_getenvid(), binaryname, file, line);
	vcprintf(fmt, ap);
  801105:	89 74 24 04          	mov    %esi,0x4(%esp)
  801109:	8b 45 10             	mov    0x10(%ebp),%eax
  80110c:	89 04 24             	mov    %eax,(%esp)
  80110f:	e8 b8 ef ff ff       	call   8000cc <vcprintf>
	cprintf("\n");
  801114:	c7 04 24 ac 13 80 00 	movl   $0x8013ac,(%esp)
  80111b:	e8 0d f0 ff ff       	call   80012d <cprintf>
