...
.LFBB1:
	...
	pushl	%ebx
	subl	$20, %esp
	.stabn	68,0,106,.LM1-.LFBB1
.LM1:
	movl	12(%ebp), %eax
	movl	$.LC0, (%esp)
	.stabn	68,0,101,.LM2-.LFBB1
.LM2:
	leal	20(%ebp), %ebx
...
.LFBB2:
	...
	pushl	%ebx
	subl	$16, %esp
	.stabn	68,0,77,.LM8-.LFBB2
.LM8:
	movl	16(%ebp), %ebx
	.stabn	68,0,80,.LM9-.LFBB2
.LM9:
	cmpl	$0, panicstr
	je	.L8
	.p2align 4,,7
	.p2align 3
.L6:
	.stabn	68,0,96,.LM10-.LFBB2
.LM10:
	movl	$0, (%esp)
	call	monitor
	jmp	.L6
.L8:
	.stabn	68,0,82,.LM11-.LFBB2
.LM11:
	movl	%ebx, panicstr
...
# 85 "kern/init.c" 1
	cli; cld
# 0 "" 2
	.stabn	68,0,88,.LM13-.LFBB2
.LM13:
#NO_APP
	movl	12(%ebp), %eax
	.stabn	68,0,76,.LM14-.LFBB2
.LM14:
	leal	20(%ebp), %esi
	.stabn	68,0,88,.LM15-.LFBB2
.LM15:
	movl	$.LC2, (%esp)
	movl	%eax, 8(%esp)
	movl	8(%ebp), %eax
...
.LM30:
	pushl	%edi
	pushl	%ebx
	.stabn	68,0,27,.LM31-.LFBB4
.LM31:
	leal	-266(%ebp), %ebx
	.stabn	68,0,24,.LM32-.LFBB4
.LM32:
	subl	$288, %esp
	.stabn	68,0,27,.LM33-.LFBB4
.LM33:
	testb	$2, %bl
	movl	%ebx, %edi
	movb	$0, -9(%ebp)
...
.LM35:
	leal	-9(%ebp), %edi
	.stabn	68,0,32,.LM36-.LFBB4
.LM36:
	movl	%eax, 8(%esp)
	movl	$0, 4(%esp)
	movl	$edata, (%esp)
	call	memset
	.stabn	68,0,36,.LM37-.LFBB4
.LM37:
	call	cons_init
	.stabn	68,0,43,.LM38-.LFBB4
.LM38:
	movl	$3, 4(%esp)
	movl	$.LC5, (%esp)
	call	cprintf
	.stabn	68,0,45,.LM39-.LFBB4
.LM39:
	leal	-10(%ebp), %eax
	movl	%eax, 12(%esp)
	movl	%edi, 8(%esp)
	...
	movl	$.LC6, (%esp)
	call	cprintf
	.stabn	68,0,46,.LM40-.LFBB4
.LM40:
	movl	$22, 4(%esp)
	movl	$.LC7, (%esp)
	call	cprintf
	.stabn	68,0,48,.LM41-.LFBB4
.LM41:
	movsbl	-10(%ebp),%eax
	movl	$.LC8, (%esp)
	movl	%eax, 8(%esp)
	...
	movl	%eax, 4(%esp)
	call	cprintf
	.stabn	68,0,49,.LM42-.LFBB4
.LM42:
	movl	$0, 4(%esp)
	movl	$.LC9, (%esp)
	call	cprintf
	.stabn	68,0,50,.LM43-.LFBB4
.LM43:
	movl	$255, 8(%esp)
	movl	$13, 4(%esp)
	movl	%ebx, (%esp)
	call	memset
	.stabn	68,0,51,.LM44-.LFBB4
.LM44:
	movl	%edi, 8(%esp)
	movl	%ebx, 4(%esp)
	movl	$.LC10, (%esp)
	call	cprintf
	.stabn	68,0,52,.LM45-.LFBB4
.LM45:
	movsbl	-9(%ebp),%eax
	movl	$.LC11, (%esp)
	movl	%eax, 4(%esp)
	call	cprintf
	.stabn	68,0,53,.LM46-.LFBB4
.LM46:
	movl	$-1024, 8(%esp)
	movl	$1024, 4(%esp)
	movl	$.LC12, (%esp)
	call	cprintf
	.stabn	68,0,57,.LM47-.LFBB4
.LM47:
	movl	$5, (%esp)
	call	test_backtrace
	.p2align 4,,7
	.p2align 3
.L17:
	.stabn	68,0,61,.LM48-.LFBB4
.LM48:
	movl	$0, (%esp)
	call	monitor
	jmp	.L17
.L19:
	.stabn	68,0,27,.LM49-.LFBB4
.LM49:
	stosw
	movw	$254, %dx
	.p2align 4,,2
	...
	.stabs	"chnum1:(0,2)",128,0,0,-9
	.stabs	"chnum2:(0,2)",128,0,0,-10
	.stabs	"ntest:(0,20)=ar(0,21)=r(0,21);0;-1;;0;255;(0,2)",128,0,0,-266
